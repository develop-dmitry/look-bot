...
class MakeupBuilder extends AbstractBuilder implements MakeupBuilderInterface
{
    ...
    public function make(): MakeupInterface
    {
        ...
        $makeup = (new Makeup($this->valueFactory, $this->styleRepository, $this->eventRepository))
